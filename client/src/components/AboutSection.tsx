export default function AboutSection() {
  ...
  return (
    <>
      ...
      {/* Seção Missão */}
      <section id="missao" className="bg-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Seção Visão */}
      <section id="visao" className="bg-[#1a1a1a] py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-yellow-400 text-sm font-bold uppercase tracking-wider mb-2">
              NOSSA VISÃO
      ...
      {/* Seção Valores */}
      <section id="valores" className="bg-black py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-yellow-400 text-sm font-bold uppercase tracking-wider mb-2">
              NOSSOS VALORES
